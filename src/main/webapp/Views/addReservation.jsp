						...
						<div class="row g-0">
							...
							<div class="col-md-6 col-lg-7 d-flex align-items-center">
								<div class="card-body p-4 p-lg-5 text-black">
									...
									<h1 style="text-align: center;">Vehicle Reservation</h1>
									<form action="${pageContext.request.contextPath}/ReservasionController" method="post">
										<div class="form-group">
											<label for="user_id">User ID</label> <br>
											<input type="text" name="user_id" value="<%=user.getId()%>" class="form-control" readonly>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="rent_date">Input Rental Date </label> 
											<input type="date" name="rent_date" class="form-control" required="required">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label
											for="add_id">Vehicle ID </label> 
											<input type="number" value="${vehicle.id}" name="add_id" class="form-control" readonly>
										</div> <br>
										<div class="form-group">
											<center><input type="submit" value="Request" name="action" class="btn btn-success g-lg-3"></center>
										</div>
									</form>
