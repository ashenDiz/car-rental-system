										...
										<div class="card-body p-4 p-lg-5 text-black">
											...
											<form action="${pageContext.request.contextPath}/PaymentController" method="post">
												...
												<div class="form-group">
													<label for="res_id">Reservation ID</label> <br>
													<input type="text" value="${res_id}" name="res_id" class="form-control" readonly="readonly">
												</div>
												<div class="form-group">
													<label for="card_no">Card No</label> <br>
													<input type="number" name="card_no"  class="form-control" required="required">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="date" name="exp_date"  class="form-control" required="required">
												</div>
												<div class="form-group">
													<label for="cvv">CVV </label> 
													<input type="number" name="cvv" class="form-control" required="required">
												</div>
												 <br>
												<div class="form-group">
													<center><input type="submit" value="pay" name="action" class="btn btn-success g-lg-3"></center>
												</div>
											</form>
