				...
				<c:forEach items="${Payments}" var="payment">
					<tr>
						...
						<form action="${pageContext.request.contextPath}/PaymentController" method="get">
							...
							<input type="hidden" value="${payment.res_id}" name="res_id">
							<input type="hidden" value="<%=user.getId()%>" name="user_id">
							<td><button type="submit" name="action" class="btn btn-danger" value="delete">Delete</button></td>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="${pageContext.request.contextPath}/Images/Design/slider_3.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="${pageContext.request.contextPath}/Images/Design/slider_1.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="${pageContext.request.contextPath}/Images/Design/slider_2.jpg" alt="Third slide">
            </div>
          </div>
