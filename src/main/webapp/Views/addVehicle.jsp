...
<style type="text/css">
.login_img {
	background: url("${pageContext.request.contextPath}/Images/Design/addVehicle_logo.jpg");
						...
						<div class="row g-0">
							...
							<div class="col-md-6 col-lg-7 d-flex align-items-center">
								...
								<div class="card-body p-4 p-lg-5 text-black">
									...
									<form action="${pageContext.request.contextPath}/VehicleController?action=Post" method="post"
										enctype="multipart/form-data">
										<input type="hidden" value="<%=user.getId()%>" name="user_id">
										<div class="form-group">
											<label for="img">Select Image</label> <br>
											<input type="file" name="img" class="form-control-file" required="required">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="m_year">Enter manufacture year </label> 
											<input type="number" name="m_year" class="form-control" required="required"> 
										</div>
										<div class="form-group">
											<label for="reg_year">Enter register year </label> 
											<input type="year" name="reg_year" class="form-control" required="required"> 
										</div>
										<div class="form-group">
											<label
										...
										<div class="form-group">
											...
											<input type="text"
												name="capacity" class="form-control" required="required">
										</div>
										<div class="form-group">
											<label for="mileage">Enter Mileage
											</label> 
											<input type="number" name="mileage" class="form-control" required="required">
										</div>
										<div class="form-group">
											<label for="price">Enter
												price </label> <input type="number" name="price" class="form-control" required="required"> 
										</div> <br>
										<div class="form-group">
											<center><input type="submit" value="Submit"  class="btn btn-primary mb-2"></center>
										</div>
									</form>
